...
const LandingAnimation = dynamic(() => import("@/src/features/DrawLandingAnimation/LandingAnimation"), { 
  ssr: false 
});
const ScrollIndicator = dynamic(() => import("@/src/components/ui/ScrollIndicator"), { 
  ssr: false 
});
const ProjectCubes = dynamic(() => import("@/src/features/ProjectCubes/ProjectCubes"), { 
  ssr: false 
});
